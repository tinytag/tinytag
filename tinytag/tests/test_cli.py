...
tinytag_attributes = {
    'adrmBlob', 'album', 'albumartist', 'artist', 'audio_offset',
    'bitdepth', 'bitrate', 'channels', 'checksum', 'comment',
    'composer', 'description', 'disc', 'disc_total', 'duration',
    'extra', 'filesize', 'filename', 'genre', 'samplerate',
