...
testfiles = OrderedDict([
    ...
    ('samples/riff_extra_zero.wav',
        {'extra': {}, 'channels': 2, 'duration': 0.11609977324263039, 'filesize': 20670,
         ...
         'title': 'Mission Bass', 'track': None, 'album': '808 Bass Express', 'comment': None,
    ...
    ('samples/riff_extra_zero_2.wav',
        {'extra': {}, 'channels': 2, 'duration': 0.11609977324263039, 'filesize': 20682,
         ...
         'artist': 'The Jimmy Castor Bunch', 'title': 'It\'s Just Begun', 'track': None,
         'album': 'The Perfect Beats, Vol. 4', 'comment': None, 'genre': 'Pop Electronica',
         'year': None}),
