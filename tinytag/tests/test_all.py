...
testfiles = dict([
    ...
    ('samples/id3v22_image.mp3',
        {'extra': {'rva': ['\x10'], 'bpm': ['131']}, 'title': 'Kids (MGMT Cover) ',
         'filesize': 35924,
    ...
    ('samples/id3_xxx_lang.mp3',
        {'extra': {'script': ['Latn'],
                   ...
                   'tsop': ['Perfect Circle, A'], 'original_year': ['2004'], 'tdat': ['0211'],
    ...
    ('samples/id3_multiple_artists.mp3',
        {'filesize': 2007, 'bitrate': 57.39124999999999, 'channels': 1,
         ...
         'extra': {'artist': ['artist2', 'artist3', 'artist4', 'artist5',
                              'artist6', 'artist7']},
    ...
    ('samples/test.opus',
        {'extra': {'encoder': ['Lavc57.24.102 libopus'], 'arrange': ['\u6771\u65b9'],
                   'catalogid': ['ARCD0024'], 'discid': ['A212230D'],
                   'event': ['\u4f8b\u5927\u796d5'],
    ...
    ('samples/id3_header_with_a_zero_byte.wav',
        {'extra': {'title': ['Stacked']}, 'channels': 1, 'duration': 1.0, 'filesize': 44280,
         'bitrate': 352.8, 'samplerate': 22050, 'bitdepth': 16, 'artist': 'Purpley',
         'title': 'Test000', 'track': 17,
         'album': 'prototypes'}),
    ('samples/adpcm.wav',
    ...
    ('samples/with_id3_header.flac',
        {'extra': {'id': ['8591671910'], 'artist': ['群星'], 'album': ['   '],
                   'title': ['A 梦 哆啦 机器猫 短信铃声']}, 'filesize': 64837,
    ...
    ('samples/with_padded_id3_header2.flac',
        {'extra': {'mcdi': ['2\x01\x05\x00\x10\x01\x00\x00\x00\x00\x00\x00\x10\x02\x00\x00\x00W5'
                   ...
                   'artist': ['Unbekannter Künstler'], 'album': ['Unbekannter Titel'],
                   'title': ['Track01']},
    ...
    ('samples/flac_with_image.flac',
        {'extra': {}, 'filesize': 80000,
         'album': 'smilin´ in circles', 'artist': 'Andreas Kümmert',
    ...
    ('samples/lossless.wma',
        {'extra': {},
         'samplerate': 44100, 'bitrate': 667.296, 'filesize': 2500, 'bitdepth': 16,
         'duration': 43.133, 'channels': 2}),
    ('samples/wma_invalid_track_number.wma',
        {'extra': {'encoder_settings': ['Lavf60.16.100']},
         'filesize': 3940, 'bitrate': 128.0,
    ...
    ('samples/test3.m4a',
        {'extra': {'publisher': ['test7'], 'bpm': ['99999'],
    ...
    ('samples/M1F1-mulawC-AFsp.afc',
        {'extra': {'comment': ['user: kabal@CAPELLA', 'program: CopyAudio']},
         'channels': 2, 'duration': 2.936625, 'filesize': 47148,
...
def test_to_str() -> None:
    ...
    assert (
        ...
        "'bitdepth': None, 'samplerate': 44100, 'artist': 'Anais Mitchell', "
        "'albumartist': None, 'composer': None, 'album': 'Hymns for the Exiled', 'disc': None, "
        "'disc_total': None, 'title': 'cosmic american', 'track': 3, 'track_total': 11, "
        "'genre': None, 'year': '2004', 'comment': 'Waterbug Records, www.anaismitchell.com', "
...
def test_to_str_images() -> None:
    ...
    assert str(tag.images) == (
        "{'front_cover': [], 'back_cover': [], 'leaflet': [], 'media': [], 'other': [], "
